...
public static partial class MVC
{
    ...
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.AccountController Account = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_AccountController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.FilterTestController FilterTest = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_FilterTestController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.HomeController Home = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_HomeController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.ModelBinderExampleController ModelBinderExample = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_ModelBinderExampleController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.RouteDemoController RouteDemo = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_RouteDemoController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.TryUpdateModelController TryUpdateModel = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_TryUpdateModelController();
    public static ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.UserController User = new ItAcademy.Demo.ClassWork.Client.Mvc.Controllers.T4MVC_UserController();
    public static T4MVC.AcoountController Acoount = new T4MVC.AcoountController();
...
namespace T4MVC
{
    ...
    public class AdminClass
    {
        ...
        public ItAcademy.Demo.ClassWork.Client.Mvc.Areas.Admin.Controllers.HomeController Home = new ItAcademy.Demo.ClassWork.Client.Mvc.Areas.Admin.Controllers.T4MVC_HomeController();
    ...
    public class ProductClass
    {
        ...
        public ItAcademy.Demo.ClassWork.Client.Mvc.Areas.Product.Controllers.HomeController Home = new ItAcademy.Demo.ClassWork.Client.Mvc.Areas.Product.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string demo_integration_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/demo.integration.min.js") ? Url("demo.integration.min.js") : Url("demo.integration.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public static readonly string demo_integration_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/demo.integration.js"); 
